...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">finanzas-al-correo-web documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/AnalysisApiService.html" data-type="entity-link" >AnalysisApiService</a>
                                </li>
                                <li class="link">
                                ...
                                <li class="link">
                                    <a href="injectables/ReportDetailsApiService.html" data-type="entity-link" >ReportDetailsApiService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/AnalysisData.html" data-type="entity-link" >AnalysisData</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/AnalysisItem.html" data-type="entity-link" >AnalysisItem</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CompoDocConfig.html" data-type="entity-link" >CompoDocConfig</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/DailyReport.html" data-type="entity-link" >DailyReport</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/MetricsItem.html" data-type="entity-link" >MetricsItem</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ReportDetails.html" data-type="entity-link" >ReportDetails</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/reportItem.html" data-type="entity-link" >reportItem</a>
                            </li>
                            <li class="link">
